...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="header nav-small-cap">View Deatils</li>
        <li class="active">
          <a href="../../index.php">
            <i class="icon-home"></i> <span>Main Site</span>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	    <!-- Default box -->
	  <div class="box box-inverse box-primary bg-hexagons-white pull-up">
        <div class="box-body">
			<div class="row">
				<div class="col-md-3 col-12">
				 	<div class="text-center">
                        <h1 class="text-bold count"></h1>
                        <hr class="w-50 my-5 b-2 border-dark">
                        <h5 class="mt-10">Confirmed Positive</h5>
                    </div>
				</div>
				<div class="col-md-3 col-12">
				 	<div class="text-center">
			...
			<div class="col-lg-9 col-12">
				<div class="box">
					<div class="box-header with-border">
					  <h3 class="box-title">Detail Chart - </h3>
					...
					<div class="box-body">
						<div class="chart">
							<div id="chartDetail" style="height: 500px;"></div>
						</div>
					</div>
					<!-- /.box-body -->
				  </div>
			  ...
			  <!-- Chart -->
				...
				<div class="box-body">
				  <div class="chart">
					...
					<div id="gujarat" class="" style="height:500px;"></div>
				  </div>
				</div>
				<!-- /.box-body -->
		...
		<div class="col-">
			<!-- Default box -->
			  <div class="box box-solid bg-dark">
				<div class="box-header with-border">
				  <h3 class="box-title">District Wise details</h3>
		...
		<div class="row">
		   ...
		   <div class="col-lg-5 col-12">
			  ...
			  <div class="box">
				...
				<div class="box-body">
				  <div class="chart">
					<div id="gujrat2" class="" style="height:480px;"></div>	
				  </div>
				</div>
				<!-- /.box-body -->
			  </div>
		  ...
		  <div class="col-lg-6 col-12">
			  <div class="box">
				...
				<div class="box-body">
					<div class="chart">
						<div id="gujarat1" style="height: 680px;"></div>
					</div>
				</div>
				<!-- /.box-body -->
			  </div>
  ...
  <footer class="main-footer">
	  ...
	  &copy; 2020 <a href="https://www.multipurposethemes.com/">India Covid19</a>. All Rights Reserved.
  </footer>
...
<!-- ./wrapper -->
	...
	<script src="./js/pages/amcharts/detailChart.js" type="text/javascript"></script>
	...
	<script src="https://rawgit.com/Anujarya300/bubble_maps/master/data/geography-data/datamaps.none.js"></script>
        ...
        <script src="../../../assets/plugins/jvectormap/jquery-jvectormap-in-mill2.js"></script>
        ...
        <script src="../../../assets/plugins/jvectormap/jquery-jvectormap-europe-mill.js"></script>
        <script src="../../../assets/plugins/jvectormap/jvectormap-active.js"></script>
